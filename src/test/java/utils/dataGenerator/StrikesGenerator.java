...
public class StrikesGenerator {

    @Getter
    private static Double[] strikes = {15.0, 15.5, 16.0, 16.5, 17.0, 17.5, 18.0, 18.5, 19.0, 19.5, 20.0, 20.5, 21.0,
    ...
    public static Double[] getStrikes() {
        return strikes;
    }
}
