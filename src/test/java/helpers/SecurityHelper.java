...
import static submodules.APISubmodule.MK_COMPANIES;
...
public class SecurityHelper {
    ...
    public static Security getCompanies(String httpRequest, String keyword){
        ...
        Response response = new RequestFactory().createRequest(httpRequest, MARKET_DATA, MK_COMPANIES
                , queryParams, null);
    ...
    public static  boolean validateWord(String word, Security security){
        ...
        while(cont < security.getCompanies().size() && match){
            String word1 = security.getCompanies().get(cont).getDescription().toUpperCase();
